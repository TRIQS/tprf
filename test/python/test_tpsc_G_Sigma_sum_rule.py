...
def test_Sigma_G_sum_rule():
    ...
    S.solve(check_self_consistency=False)

    # get trace of Sigma*G
    trace_SigmaG = S._get_density(S.sigma_wk * S.g0_wk)

    # test against exact result
    np.testing.assert_array_almost_equal(trace_SigmaG, S.U*S.docc)


if __name__ == '__main__':
    test_Sigma_G_sum_rule()
