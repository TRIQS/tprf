...
template <Channel_t CH> g2_iw_t chi0_from_gg2(g_iw_cvt g, g2_iw_cvt g2);
  ...
  /** Bubble susceptibility \f$ \chi^{(0)} = GG \f$ in the Particle-Hole channel
  ...
  @param g single particle Green's function \f$ G_{ab}(\nu) \f$
  @param g2 two-particle Green's function with the mesh to use for
   \f$ \chi^{(0)} \f$
  @return chi0 particle-hole bubble
   \f$ \chi^{(0)}_{\bar{a}b\bar{c}d}(\omega, \nu,\nu') \f$
  */
g2_iw_t chi0_from_gg2_PH(g_iw_vt g, g2_iw_vt g2);

  /** Bubble susceptibility \f$ \chi^{(0)} = GG \f$ in the Particle-Particle channel
...
/** Generalized susceptibility \f$ \chi = G^{(2)} - GG \f$ in the
 Particle-Hole channel
   ...
   \f$ G^{(2)}_{\bar{a}b\bar{c}d}(\omega, \nu, \nu') \f$
     @return chi generalized particle-hole susceptibility
   \f$ \chi_{\bar{a}b\bar{c}d}(\omega, \nu,\nu') \f$
  */
...
/** Bubble susceptibility \f$ \chi^{(0)} = GG \f$ in the Particle-Hole channel
     ...
     @param g single particle Green's function \f$ G_{ab}(\tau) \f$
     @return chi0 particle-hole bubble
   \f$ \chi^{(0)}_{\bar{a}b\bar{c}d}(\tau) \f$
  */
