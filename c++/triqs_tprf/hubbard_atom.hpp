...
/** Single-particle Green's function of the Hubbard atom at half-filling
     ...
     @return g single-particle Green's function of the Hubbard atom \f$ G(i\omega_n) \f$
  */
g_iw_t single_particle_greens_function(int nw, double beta, double U);

/** Magnetic susceptibility of the Hubbard atom at half-filling \f$ \chi(\omega, \nu, \nu') \f$
     ...
     @param beta inverse temperature
     @param U Hubbard U interaction parmeter
     @return chi magnetic susceptibility \f$ \chi(\omega, \nu, \nu') \f$
  */
g2_iw_t chi_ph_magnetic(int nw, int nwf, double beta, double U);

/** Magnetic vertex function in the particle-hole channel of the Hubbard atom at half-filling \f$ \Gamma(\omega, \nu, \nu') \f$
    ...
    @param beta inverse temperature
    @param U Hubbard U interaction parmeter
    @return gamma magnetic susceptibility \f$ \Gamma(\omega, \nu, \nu') \f$
  */
