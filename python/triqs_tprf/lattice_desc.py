...
module.add_function ("triqs_tprf::chi_Dwr_t triqs_tprf::fourier_wk_to_wr (triqs_tprf::chi_Dwk_cvt chi_wk)")
...
module.add_function ("triqs_tprf::chi_Dwk_t triqs_tprf::fourier_wr_to_wk (triqs_tprf::chi_Dwr_cvt chi_wr)")
...
module.add_function ("triqs_tprf::chi_Dtr_t triqs_tprf::fourier_wr_to_tr (triqs_tprf::chi_Dwr_cvt chi_wr, int nt = -1)")
...
module.add_function ("triqs_tprf::chi_Dwr_t triqs_tprf::fourier_tr_to_wr (triqs_tprf::chi_Dtr_cvt chi_tr, int nw = -1)")
...
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_product (triqs_tprf::chi_wk_vt Gamma_pp, triqs_tprf::g_wk_vt g_wk, triqs_tprf::g_wk_vt gbar_wk, triqs_tprf::g_wk_vt delta_wk, bool linearized=true)", doc = r"""""")
...
out
     Gives the result of the product :math:`\Delta^{\mathrm{s/t}, \mathrm{out}}`""")
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_product_fft (triqs_tprf::chi_tr_vt Gamma_pp_dyn_tr, triqs_tprf::chi_r_vt Gamma_pp_const_r, triqs_tprf::g_wk_vt g_wk, triqs_tprf::g_wk_vt gbar_wk, triqs_tprf::g_wk_vt delta_wk, bool linearized=true)", doc = r"""""")
...
module.add_function ("triqs_tprf::g_Dwk_t triqs_tprf::eliashberg_product_fft (triqs_tprf::chi_Dtr_vt Gamma_pp_dyn_tr, triqs_tprf::chi_r_vt Gamma_pp_const_r, triqs_tprf::g_Dwk_vt g_wk, triqs_tprf::g_Dwk_vt gbar_wk, triqs_tprf::g_Dwk_vt delta_wk, bool linearized=true)", doc = r"""Add documentation!""")
...
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_product_fft_constant (triqs_tprf::chi_r_vt Gamma_pp_const_r, triqs_tprf::g_wk_vt g_wk, triqs_tprf::g_wk_vt gbar_wk, triqs_tprf::g_wk_vt delta_wk, bool linearized=true)", doc = r"""""")
...
module.add_function ("triqs_tprf::g_Dwk_t triqs_tprf::eliashberg_product_fft_constant (triqs_tprf::chi_r_vt Gamma_pp_const_r, triqs_tprf::g_Dwk_vt g_wk, triqs_tprf::g_Dwk_vt gbar_wk, triqs_tprf::g_Dwk_vt delta_wk, bool linearized=true)", doc = r"""""")
...
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_g_delta_g_product (triqs_tprf::g_wk_vt g_wk, triqs_tprf::g_wk_vt gbar_wk, triqs_tprf::g_wk_vt delta_wk)", doc = r"""""")
...
module.add_function ("triqs_tprf::g_Dwk_t triqs_tprf::eliashberg_g_delta_g_product (triqs_tprf::g_Dwk_vt g_wk, triqs_tprf::g_Dwk_vt gbar_wk, triqs_tprf::g_Dwk_vt delta_wk)", doc = r"""""")
...
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_F_wk(triqs_tprf::g_wk_vt g_wk, triqs_tprf::g_wk_vt gbar_wk, triqs_tprf::g_wk_vt delta_wk)", doc = r"""""")
...
module.add_function ("triqs_tprf::g_Dwk_t triqs_tprf::eliashberg_F_wk(triqs_tprf::g_Dwk_vt g_wk, triqs_tprf::g_Dwk_vt gbar_wk, triqs_tprf::g_Dwk_vt delta_wk)", doc = r"""""")
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_g_wk(triqs_tprf::g_wk_vt g_in_wk, triqs_tprf::g_wk_vt delta_wk)", doc = r"""""")
module.add_function ("triqs_tprf::g_wk_t triqs_tprf::eliashberg_g_wk(triqs_tprf::g_wk_vt g_in_wk, triqs_tprf::g_wk_vt gbar_in_wk, triqs_tprf::g_wk_vt delta_wk)", doc = r"""""")
module.add_function ("triqs_tprf::g_Dwk_t triqs_tprf::eliashberg_g_wk(triqs_tprf::g_Dwk_vt g_in_wk, triqs_tprf::g_Dwk_vt delta_wk)", doc = r"""""")
module.add_function ("triqs_tprf::g_Dwk_t triqs_tprf::eliashberg_g_wk(triqs_tprf::g_Dwk_vt g_in_wk, triqs_tprf::g_Dwk_vt gbar_in_wk, triqs_tprf::g_Dwk_vt delta_wk)", doc = r"""""")
