...
module.add_function ("gf<prod<triqs::lattice::brillouin_zone, triqs::gfs::imfreq>, tensor_valued<4> > triqs_tprf::chiq_sum_nu_from_g_wk_and_gamma_PH (triqs_tprf::gk_iw_t g_wk, triqs_tprf::g2_iw_vt gamma_ph_wnn, int tail_corr_nwf = -1)", doc = r"""""")

module.add_function ("gf<prod<triqs::lattice::brillouin_zone, triqs::gfs::imfreq>, tensor_valued<4> > triqs_tprf::chiq_sum_nu_from_e_k_sigma_w_and_gamma_PH (double mu, triqs_tprf::ek_vt e_k, triqs_tprf::g_iw_vt sigma_w, triqs_tprf::g2_iw_vt gamma_ph_wnn, int tail_corr_nwf = -1)", doc = r"""""")

module.add_function ("gf<prod<triqs::lattice::brillouin_zone, triqs::gfs::imfreq>, tensor_valued<4> > triqs_tprf::chiq_sum_nu (triqs_tprf::chiq_t chiq)", doc = r"""""")
