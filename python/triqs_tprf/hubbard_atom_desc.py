...
# c++2py ../../c++/triqs_tprf/hubbard_atom.hpp --members_read_only -N triqs_tprf::hubbard_atom -a triqs_tprf -m hubbard_atom -o hubbard_atom -C triqs --includes="../../c++" --moduledoc="Exact correlation functions for the hubbard atom" --cxxflags="-std=c++20" --target_file_only
