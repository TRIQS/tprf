...
# c++2py ../../c++/triqs_tprf/freq_conv.hpp --members_read_only -N triqs_tprf -a triqs_tprf -m freq_conv -o freq_conv -C triqs --includes="../../c++" --moduledoc="functionality for changing frequency conventions" --cxxflags="-std=c++20"
