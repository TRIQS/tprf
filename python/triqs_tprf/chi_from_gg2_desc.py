...
# c++2py ../../c++/triqs_tprf/chi_from_gg2.hpp --members_read_only -N triqs_tprf -a triqs_tprf -m chi_from_gg2 -o chi_from_gg2 -C triqs --moduledoc="Calculation of generalized susceptibilities" --cxxflags="-std=c++17"
