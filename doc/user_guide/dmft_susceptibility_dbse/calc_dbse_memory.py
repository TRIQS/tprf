...
#
# Copyright (C) 2024 by Hugo U. R. Strand and Erik G. C. P. van Loon
# Authors: Hugo U. R. Strand, Erik G. C. P. van Loon
#
...
for nwf in [5,]:
    ...
    p.chi_kw_dbse = solve_lattice_dbse_lomem(g_wk, F_wnn, p.L_wn, p.chi_imp_w) 
    p.chi_kw_dbse_ref = solve_lattice_dbse(g_wk, F_wnn, p.L_wn, p.chi_imp_w) 

    np.testing.assert_almost_equal(p.chi_kw_dbse.data, p.chi_kw_dbse_ref.data)
    print('DBSE and lomem DBSE agree.')
